...
export const metadata: Metadata = {
  ...
  description: 'How orignx.dev collects, uses, and protects your information.',
};
      ...
      <Card className="w-full max-w-2xl shadow-lg border-muted bg-background">
        <CardContent className="p-6 md:p-10">
          ...
          <p className="mb-6 text-muted-foreground">
            Welcome to orignx.dev! Your privacy is important to us. This Privacy
          ...
          <ul className="list-disc list-inside mb-6 space-y-2">
            <li>
              ...
              contact us via the contact form or email, we may collect your
          ...
          <p className="mb-6">
            ...
            collect and process your data according to their own privacy
            policies.
          </p>
          ...
          <p className="mb-6">
            ...
            unauthorized access, disclosure, or misuse. However, please note
          ...
          <p className="mb-6">
            ...
            contact us at{' '}
            <a href="mailto:damrongsak.sam@gmail.com" className="underline">
              Support team
            </a>
            .
          </p>
