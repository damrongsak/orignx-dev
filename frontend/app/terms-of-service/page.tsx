      ...
      <Card className="w-full max-w-2xl shadow-lg border-muted bg-background">
        <CardContent className="p-6 md:p-10">
          ...
          <p className="mb-6 text-muted-foreground">
            Welcome to <strong>orignx.dev</strong>. By accessing or using our
          ...
          <p className="mb-4">
            ...
            use the website in any way that may harm, disrupt, or interfere with
          ...
          <p className="mb-4">
            ...
            property of <strong>orignx.dev</strong>. Unauthorized use,
