    ...
    return (
        <main className="max-w-4xl mx-auto px-4 py-20 space-y-8">
            ...
            <motion.p className="text-muted-foreground text-lg" {...fadeIn}>
                I&#39;m Damrongsak Samanras, a System Analyst with over 15 years
                of experience across architecture design, data engineering, and
                full-stack development. My work spans scalable systems, legacy
                integration, and enterprise-grade solutions for energy and
                logistics platforms like PTT, PTTOR, and NGV networks.
            </motion.p>
            <motion.ul
